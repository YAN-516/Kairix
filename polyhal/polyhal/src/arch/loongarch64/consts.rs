...
// pub const KERNEL_CORE_STACK_BASE: usize = KERNEL_MEMORY_SPACE.1 - PAGE_SIZE;
pub const KERNEL_CORE_STACK_BASE: usize = 0x9000_0000_87ff_ffff;
// pub const KERNEL_CORE_STACK_BASE: usize = 0x9000_0000_ffff_ffff;
