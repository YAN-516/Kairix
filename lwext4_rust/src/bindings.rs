...
pub const CONFIG_EXT4_BLOCKDEVS_COUNT: u32 = 16;
pub const CONFIG_EXT4_MAX_MP_NAME: u32 = 128;
pub const CONFIG_EXT4_MOUNTPOINTS_COUNT: u32 = 16;
...
pub struct ext4_fs_lock_stats {
    ...
    pub transaction_samples_truncated: u32,
    pub transaction_owners: [usize; 8usize],
    pub transaction_ptrs: [usize; 8usize],
    pub transaction_depths: [u32; 8usize],
    pub inode_sample_count: u32,
    pub inode_samples_truncated: u32,
    pub inode_shards: [u16; 8usize],
    pub inode_states: [u32; 8usize],
    pub inode_writer_owners: [usize; 8usize],
    pub inode_writer_depths: [u32; 8usize],
    pub inode_writer_inodes: [u32; 8usize],
    pub inode_reader_waiters: [usize; 8usize],
    pub inode_writer_waiters: [usize; 8usize],
    pub inode_reader_wait_inodes: [u32; 8usize],
    pub inode_writer_wait_inodes: [u32; 8usize],
    pub inode_waiting_readers: [u32; 8usize],
    pub inode_waiting_writers: [u32; 8usize],
}
unsafe extern "C" {
