...
use super::{
    FrameTracker, PhysAddr, PhysPageNum, StepByOne, VirtAddr, VirtPageNum, frame_alloc,
    frame_init_alloc,
};
...
use bitflags::*;
use core::arch::asm;
use riscv::paging::{PTE, PageTableEntryX32};
...
pub fn translated_refmut<T>(token: usize, ptr: *mut T) -> &'static mut T {
    ...
    if !is_valid {
        ...
        inner
            .vm_set
            .handle_store_page_fault_set(va, AccessType::Write);
    }
