...
pub use crate::conn::{
    kernel, Connection, IoState, KeyingMaterialExporter, Reader, SideData, Writer,
};
...
pub mod version {
    pub use crate::versions::{
        Tls12Version, Tls13Version, TLS12, TLS12_VERSION, TLS13, TLS13_VERSION,
    };
}
...
mod hash_map {
    pub(crate) use crate::std::collections::hash_map::Entry;
    pub(crate) use crate::std::collections::HashMap;
}
